...
- `C:\Users\mayil\AppData\Local\Temp\pytest-of-mayil\pytest-182\test_review_workspace_uses_pyt0\workspace\config.py`

## Findings

### 1. Hardcoded SECRET_KEY.

- **File:** `C:\Users\mayil\AppData\Local\Temp\pytest-of-mayil\pytest-182\test_review_workspace_uses_pyt0\workspace\config.py`
- **Severity:** CRITICAL
- **Category:** SECURITY
